...
<form action="{$base_dir}order.php" method="post">
	<div class="addresses">
		...
		<div class="address_add submit">
			<a href="{$base_dir_ssl}address.php?back=order.php&amp;step=1" title="{l s='Add'}">{l s='Add a new address'}</a>
		</div>
		<div id="ordermsg">
	...
	<p class="cart_navigation">
		...
		<a href="{$base_dir_ssl}order.php?step=0" title="{l s='Previous'}" class="buttonprecedent">&laquo; {l s='Previous'}</a>
		<input type="submit" name="processAddress" value="{l s='Next'} &raquo;" class="buttonorder" />
	</p>
	</p>
